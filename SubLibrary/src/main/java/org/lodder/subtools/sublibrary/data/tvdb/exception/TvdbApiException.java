...
@NullMarked
public class TvdbApiException extends TvdbException implements ApiExceptionIntf {

    @val @override HttpStatus errorCode;
    @val @override CacheStrategy cacheStrategy;
    @val @override LogLevel logLevel;

    public TvdbApiException(HttpStatus errorCode, String errorMessage, CacheStrategy cacheStrategy, LogLevel logLevel) {
        super(errorMessage);
    ...
    public static TvdbApiException noResult(String message, CacheStrategy cacheStrategy=CACHE_TEMPORARY,
    ...
    public static TvdbApiException error(Exception cause, String message=cause.getMessage(),
        ...
        return new TvdbApiException(SERVER_ERROR, cause, message, cacheStrategy, ERROR);
    }
}
