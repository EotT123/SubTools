...
@NullMarked
final class TemporaryCacheObject implements CacheObject {
    ...
    @val Time timeToLive;
    @override @val @Nullable Object value;

    TemporaryCacheObject(Time timeToLive, @Nullable Object value) {
        this(Time.now(), timeToLive, value);
    }

    private TemporaryCacheObject(Time created, Time timeToLive, @Nullable Object value) {
    ...
    public static Optional<TemporaryCacheObject> fromString(String string,
        Function<@Nullable String, Object> valueToObjectMapper) {
