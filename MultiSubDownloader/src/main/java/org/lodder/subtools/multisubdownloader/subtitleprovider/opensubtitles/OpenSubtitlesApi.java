package org.lodder.subtools.multisubdownloader.subtitleprovider.opensubtitles;
...
import org.lodder.subtools.multisubdownloader.subtitleprovider.SubtitleApi;
import org.lodder.subtools.multisubdownloader.subtitleprovider.opensubtitles.exception.OpenSubtitleApiException;
import org.lodder.subtools.multisubdownloader.subtitleprovider.opensubtitles.exception.OpenSubtitleException;
import org.lodder.subtools.multisubdownloader.subtitleprovider.opensubtitles.model.OpensubtitleId;
import org.lodder.subtools.multisubdownloader.subtitleprovider.opensubtitles.param.AiTranslatedEnum;
import org.lodder.subtools.multisubdownloader.subtitleprovider.opensubtitles.param.ForeignPartsOnlyEnum;
import org.lodder.subtools.multisubdownloader.subtitleprovider.opensubtitles.param.HearingImpairedEnum;
import org.lodder.subtools.multisubdownloader.subtitleprovider.opensubtitles.param.MachineTranslatedEnum;
import org.lodder.subtools.multisubdownloader.subtitleprovider.opensubtitles.param.MoviehashMatchEnum;
import org.lodder.subtools.multisubdownloader.subtitleprovider.opensubtitles.param.OrderDirectionEnum;
import org.lodder.subtools.multisubdownloader.subtitleprovider.opensubtitles.param.ParamIntf;
import org.lodder.subtools.multisubdownloader.subtitleprovider.opensubtitles.param.SearchSubtitlesEnum;
import org.lodder.subtools.multisubdownloader.subtitleprovider.opensubtitles.param.TrustedSourcesEnum;
import org.lodder.subtools.multisubdownloader.subtitleprovider.opensubtitles.param.TypeEnum;
            ...
            .get(() -> {
                try {
                    return Manager.getJsonArray(new PageContentParams(url:
                            ...
                            retry:new Retry(
                                1,
                                exc -> exc instanceof HttpClientException e && e.responseCode == TOO_MANY_REQUESTS,
