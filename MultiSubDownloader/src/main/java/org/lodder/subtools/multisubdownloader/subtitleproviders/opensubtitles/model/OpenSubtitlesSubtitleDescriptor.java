...
public class OpenSubtitlesSubtitleDescriptor {
	...
	private int IDMovieImdb;
	private String MovieNameEng;
	private int IDSubtitleFile;
	...
	public void setSubSize(long subSize) {
		SubSize = subSize;
	}
	...
	public int getIDSubMovieFile() {
		return IDSubMovieFile;
	}

	public void setIDSubMovieFile(int iDSubMovieFile) {
	...
	public void setSubSumCD(int subSumCD) {
		SubSumCD = subSumCD;
	}
	...
	public void setIDMovieImdb(int iDMovieImdb) {
	...
	public int getIDSubtitleFile() {
		return IDSubtitleFile;
	}

	public void setIDSubtitleFile(int iDSubtitleFile) {
