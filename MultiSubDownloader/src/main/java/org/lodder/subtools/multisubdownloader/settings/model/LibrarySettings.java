...
public class LibrarySettings {
	...
	/**
	 * @param libraryOtherFileAction
	 *            the libraryOtherFileAction to set
	 */
	...
	/**
	 * @param libraryFilenameReplacingSpaceSign
	 *            the libraryFilenameReplacingSpaceSign to set
	 */
	...
	/**
	 * @param libraryFolderReplacingSpaceSign
	 *            the libraryFolderReplacingSpaceSign to set
	 */
	...
	/**
	 * @param libraryBackupSubtitle
	 *            the libraryBackupSubtitle to set
	 */
	...
	/**
	 * @param libraryUseWebsiteFileName
	 *            the libraryUseOriginalFileName to set
	 */
	...
	/**
	 * @param libraryBackupSubtitlePath
	 *            the libraryBackupSubtitlePath to set
	 */
