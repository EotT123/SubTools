...
public abstract class GuiSearchAction extends SearchAction {
	...
	protected void validate() throws SearchSetupException {
		...
		/*
		 * The progressDialogs were re-used after the completed()-call and thus not shown. A reset()-method might get
		 * implemented. But for now the GuiSearchAction will get a reference to GUI and creates the listeners.
		 */
