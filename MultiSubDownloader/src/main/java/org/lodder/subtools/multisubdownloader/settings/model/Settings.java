...
public class Settings {
	...
	/**
	 * @param localSourcesFolders
	 *            the localSourcesFolders to set
	 */
	...
	/**
	 * @param serieSourceAddic7ed
	 *            the serieSourceAddic7ed to set
	 */
	...
	/**
	 * @param serieSourceTvSubtitles
	 *            the serieSourceTvSubtitles to set
	 */
	...
	/**
	 * @param serieSourcePodnapisi
	 *            the serieSourcePodnapisi to set
	 */
	...
	/**
	 * @param serieSourceOpensubtitles
	 *            the serieSourceOpensubtitles to set
	 */
	...
	/**
	 * @param serieSourceLocal
	 *            the serieSourceLocal to set
	 */
	...
	/**
	 * @param autoUpdateMapping
	 *            the autoUpdateMapping to set
	 */
	...
	/**
	 * @param optionSubtitleExactMatch
	 *            the optionSubtitleExactMatch to set
	 */
	...
	/**
	 * @param optionSubtitleKeywordMatch
	 *            the optionSubtitleKeywordMatch to set
	 */
	...
	/**
	 * @param processEpisodeSource
	 *            the processEpisodeSource to set
	 */
	...
	/**
	 * @param optionSubtitleExcludeHearingImpaired
	 *            the optionSubtitleExcludeHearingImpaired to set
	 */
