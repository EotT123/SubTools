...
public enum Addic7edLanguage {
    ...
    CANTONESE(Language.CANTONESE, "Cantonese", 64),
    CATALAN(Language.CATALAN, "Català", 12),
    CHINESE_SIMPLIFIED(Language.CHINESE_SIMPLIFIED, "Chinese (Simplified)", 41),
    CHINESE_TRADITIONAL(Language.CHINESE_TRADITIONAL, "Chinese (Traditional)", 24),
    CROATIAN(Language.CROATIAN, "Croatian", 31),
    CZECH(Language.CZECH, "Czech", 14),
    DANISH(Language.DANISH, "Danish", 30),
    DUTCH(Language.DUTCH, "Dutch", 17),
    ENGLISH(Language.ENGLISH, "English", 1),
    ESTONIAN(Language.ESTONIAN, "Estonian", 54),
    EUSKERA(Language.EUSKERA, "Euskera", 13),
    ...
    ROMANIAN(Language.ROMANIAN, "Romanian", 26),
    ...
    SINHALA(Language.SINHALA, "Sinhala", 60),
    SLOVAK(Language.SLOVAK, "Slovak", 25),
    SLOVENIAN(Language.SLOVENIAN, "Slovenian", 22),
    SPANISH(Language.SPANISH, "Spanish", 4),
    SPANISH_ARGENTINA(Language.SPANISH, "Spanish (Argentina)", 69),
    SPANISH_LATIN_AMERICA(Language.SPANISH, "Spanish (Latin America)", 6),
    SPANISH_SPAIN(Language.SPANISH, "Spanish (Spain)", 5),
